<#
.SYNOPSIS
    This PowerShell script configures the system to disable Solicited Remote Assistance in accordance with Windows 11 STIG WN11-CC-000155.
...
.DESCRIPTION
    ...
    setting "Configure Solicited Remote Assistance" by configuring the
