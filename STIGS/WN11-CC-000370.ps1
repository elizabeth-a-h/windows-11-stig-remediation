<#
.SYNOPSIS
    This PowerShell script configures the system to disable domain PIN logon in accordance with Windows 11 STIG WN11-CC-000370.
...
.DESCRIPTION
    ...
    setting that disables domain PIN logon by configuring the corresponding
    registry value.
