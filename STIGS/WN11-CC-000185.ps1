<#
.SYNOPSIS
    This PowerShell script configures the system to prevent AutoRun commands in accordance with Windows 11 STIG WN11-CC-000185.
...
.DESCRIPTION
    ...
    setting "Set the default behavior for AutoRun" by configuring the
