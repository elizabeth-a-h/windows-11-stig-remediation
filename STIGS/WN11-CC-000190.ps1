<#
.SYNOPSIS
    This PowerShell script configures the system to disable AutoRun for all drive types in accordance with Windows 11 STIG WN11-CC-000190.
...
.DESCRIPTION
    ...
    setting "Turn off AutoRun" for all drives.
